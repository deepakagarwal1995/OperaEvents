    ...
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"> <a href="index.html"><img class="img-fluid for-light"
                        src="{{ config('app.url') }}/assets/images/logo/logo_dark.png" alt="logo-light"><img class="img-fluid for-dark"
                        src="{{ config('app.url') }}/assets/images/logo/logo.png" alt="logo-dark"></a></div>
        ...
        <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
            <div> <a class="toggle-sidebar" href="#"> <i class="iconly-Category icli"> </i></a>
                <div class="d-flex align-items-center gap-2 ">
                    <h4 class="f-w-600">Welcome Alex</h4><img class="mt-0" src="{{ config('app.url') }}/assets/images/hand.gif"
                        alt="hand-gif">
                </div>
            </div>
        ...
        <div class="nav-right col-xxl-7 col-xl-6 col-md-7 col-8 pull-right right-header p-0 ms-auto">
            <ul class="nav-menus">
                <li class="d-md-block d-none">
                    <div class="form search-form mb-0">
                        <div class="input-group"><span class="input-icon">
                                <svg>
                                    <use href="{{ config('app.url') }}/assets/svg/icon-sprite.svg#search-header"></use>
                                </svg>
                ...
                <li class="onhover-dropdown">
                    <svg>
                        <use href="{{ config('app.url') }}/assets/svg/icon-sprite.svg#star"></use>
                    </svg>
                ...
                <li class="onhover-dropdown notification-down">
                    <div class="notification-box">
                        <svg>
                            <use href="{{ config('app.url') }}/assets/svg/icon-sprite.svg#notification-header"></use>
                                                    ...
                                                    <ul>
                                                        <li class="pr-0 pl-0 pb-3 pt-3">
                                                            <div class="media"><img
                                                                    ...
                                                                    src="{{ config('app.url') }}/assets/images/other-images/receiver-img.jpg"
                                                                    alt="">
                                                                <div class="media-body"><a class="f-light f-w-500"
                                                                        href="{{ config('app.url') }}/template/product.html">Men Blue
                                                                        T-Shirt</a>
                                                                    <div class="qty-box">
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="user-alerts"><img
                                                                ...
                                                                src="{{ config('app.url') }}/assets/images/dashboard/user/5.jpg"
                                                                alt="user" />
                                                            <div class="user-name">
                                                                <div>
                                                                    <h6><a class="f-w-500 f-14"
                                                                            href="{{ config('app.url') }}/template/user-profile.html">Floyd
                                                                            Miles</a></h6><span
                                                                ...
                                                                <div>
                                                                    <svg>
                                                                        <use
                                                                            href="{{ config('app.url') }}/assets/svg/icon-sprite.svg#more-vertical">
                                                                        </use>
                                                                    </svg>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <li>
                                                        <div class="user-alerts"><img
                                                                class="user-image rounded-circle img-fluid me-2"
                                                                src="{{ config('app.url') }}/assets/images/dashboard/user/6.jpg"
                                                                alt="user" />
                                                            <div class="user-name">
                                                                <div>
                                                                    <h6><a class="f-w-500 f-14"
                                                                            href="{{ config('app.url') }}/template/user-profile.html">Dianne
                                                                            Russell</a></h6><span
                                                ...
                                                <ul>
                                                    <li
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="user-alerts flex-shrink-0"><img
                                                                    ...
                                                                    src="{{ config('app.url') }}/assets/images/dashboard/user/3.jpg"
                                                                    alt="user" /></div>
                                                            <div class="flex-grow-1">
                                                                <div class="common-space user-id w-100">
                                                                    <div class="common-space w-100"> <a
                                                                            class="f-w-500 f-12"
                                                                            href="{{ config('app.url') }}/template/private-chat.html">Robert
                                                                            D. Hambly</a></div>
                                                                </div>
                                                    ...
                                                    <li
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="user-alerts flex-shrink-0"><img
                                                                    class="rounded-circle img-fluid img-40"
                                                                    src="{{ config('app.url') }}/assets/images/dashboard/user/7.jpg"
                                                                    alt="user" /></div>
                                                            <div class="flex-grow-1">
                                                                <div class="common-space user-id w-100">
                                                                    <div class="common-space w-100"> <a
                                                                            class="f-w-500 f-12"
                                                                            href="{{ config('app.url') }}/template/private-chat.html">Courtney
                                                                            C. Strang</a></div>
                                                                </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <div class="common-space user-id w-100">
                                                                    <div class="common-space w-100"> <a
                                                                            class="f-w-500 f-12"
                                                                            href="{{ config('app.url') }}/template/private-chat.html">Raye
                                                                            T. Sipes</a></div>
                                                                </div>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="flex-grow-1">
                                                                <div class="common-space user-id w-100">
                                                                    <div class="common-space w-100"> <a
                                                                            class="f-w-500 f-12"
                                                                            href="{{ config('app.url') }}/template/private-chat.html">Henry
                                                                            S. Miller</a></div>
                                                                </div>
                                                ...
                                                <ul>
                                                    <li class="pr-0 pl-0 pb-3">
                                                        <div class="media"><img class="img-fluid b-r-5 me-3 img-60"
                                                                src="{{ config('app.url') }}/assets/images/other-images/cart-img.jpg"
                                                                alt="">
                                                            <div class="media-body"><a class="f-light f-w-500"
                                                                    href="{{ config('app.url') }}/template/product.html">Furniture Chair for
                                                                    Home</a>
                                                                <div class="qty-box">
                                                                    <div class="input-group"> <span
                                                                            class="input-group-prepend">
                                                    ...
                                                    <li class="pr-0 pl-0 pb-3 pt-3">
                                                        <div class="media"><img class="img-fluid b-r-5 me-3 img-60"
                                                                ...
                                                                alt="">
                                                            <div class="media-body"><a class="f-light f-w-500"
                                                                    href="{{ config('app.url') }}/template/product.html">Men Cotton Blend
                                                                    Blue T-Shirt</a>
                                                                <div class="qty-box">
                                                                    <div class="input-group"> <span
                                                                            class="input-group-prepend">
                                                    ...
                                                    <li class="mb-3 total"><a href="{{ config('app.url') }}/template/checkout.html">
                                                            <h6 class="mb-0">
                ...
                <li class="profile-nav onhover-dropdown">
                    <div class="media profile-media"><img class="b-r-10" src="{{ config('app.url') }}/assets/images/dashboard/profile.png"
                            alt="">
